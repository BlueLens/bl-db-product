...
class Product(Model):
    ...
    """
    def __init__(self, id: str=None, name: str=None, host_code: str=None, host_url: str=None, host_name: str=None, tags: List[str]=None, class_code: str=None, price: int=None, currency_unit: str=None, product_url: str=None, product_no: str=None, nation: str=None, main_image: str=None, main_image_mobile: str=None, sub_images: List[str]=None, sizes: List[str]=None, discount_rate: int=None, feedback: List[Feedback]=None, version: Version=None):
        """
        ...
        :type main_image_mobile: str
        :param sub_images: The sub_images of this Product.
        :type sub_images: List[str]
    ...
    @property
    def main_image_mobile(self) -> str:
        """
    ...
    def main_image_mobile(self, main_image_mobile: str):
        """
    ...
    @sub_images.setter
    def sub_images(self, sub_images: List[str]):
        """
    ...
    @feedback.setter
    def feedback(self, feedback: List[Feedback]):
        """
